...
from views import locationGroup, location, device, ajaxListDevices, ajaxListLocations, ajaxListLocationGroups, ajaxUpdateDevice, ajaxUpdateLocation, ajaxUpdateDeviceAction, ajaxUpdateLocationGroup, ajaxInputMatrix, ajaxLoadWidgets

#urlpatterns = patterns( 'sven.apps.monitor.views',
urlpatterns = [
#     'sven.apps.monitor.views',
#    url( r'^$', index, name='index'),
#    url( r'^index$', index, name='index'),

    url( r'^locationGroups$', locationGroup, name='locationGroups'),
